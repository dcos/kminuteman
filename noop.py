...
be_ip = struct.unpack('I', socket.inet_aton("33.33.33.1"))[0]
be_port = socket.htons(3333)
...
try:
  print sock.query(MinutemanMessage('MINUTEMAN_CMD_ADD_BE', attr_list=AttrList(minuteman_attr_be_ip = be_ip, minuteman_attr_be_port = be_port)))
except Exception as e: print e

try:
  print sock.query(MinutemanMessage('MINUTEMAN_CMD_ATTACH_BE', attr_list=AttrList(minuteman_attr_vip_ip = vip_ip, minuteman_attr_vip_port = vip_port, minuteman_attr_be_ip = be_ip, minuteman_attr_be_port = be_port)))
except Exception as e: print e
